...
namespace BuiltDifferentMobileApp {
    public partial class AppShell : Xamarin.Forms.Shell {
        public AppShell() {
            ...
            Routing.RegisterRoute(nameof(ClientSummaryReportPage), typeof(ClientSummaryReportPage));
            Routing.RegisterRoute(nameof(ClientRequestsCenterPage), typeof(ClientRequestsCenterPage));
